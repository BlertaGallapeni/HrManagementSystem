...
namespace HRMS.DataAccess.DbInitializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "admin@comitas.com",
                Email = "admin@comitas.com",
                FirstName = "Admin",
                LastName = "Admin",
            ...
            }, "Comitas+2021").GetAwaiter().GetResult();

             ApplicationUser user = _db.ApplicationUsers.FirstOrDefault(u=>u.Email == "admin@comitas.com");
