...
namespace HRMSWeb.Areas.Admin.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public IActionResult Profile()
        {
            ...
            var user = _unitOfWork.ApplicationUser.GetFirstOrDefault((x => x.Id == userId && x.Deleted != true), includeProperties: "UserThumbnail,Company");
            ...
            model.ProfilePicturePath = user.UserThumbnail.Path;
        ...
        public IActionResult Profile(ProfileViewModel model, IFormFile? file)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            }
            var user = _unitOfWork.ApplicationUser.GetFirstOrDefault(x => x.Id == model.ApplicationUserVM.Id, includeProperties: "Company");
            if (file != null)
            {
                var fileName = Path.GetFileName(file.FileName);
                var uploadPath = "/images/userProfilePic/" + user.Id + "/" + fileName;

                _fileHelper.SaveFile(FileTypes.Image, file, "userProfilePic", user.Id, (int)Thumbnails.Grid, (int)Thumbnails.ProfilePicture);
